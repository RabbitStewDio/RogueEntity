...
namespace RogueEntity.Core.Utils
{
	...
	public static class MathHelpers
	{
		...
		/// </summary>
		public const float DegreePctOfCircle = 1/360f;
		...
		public static float ToDegree(float radAngle) => (float) (radAngle * (180.0 / Math.PI));
		...
		public static float ToRadian(float degAngle) => (float) (Math.PI * degAngle / 180.0);
