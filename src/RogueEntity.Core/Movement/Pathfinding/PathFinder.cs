...
{
    public class PathFinder : IPathFinder, IDisposable
    {
        readonly IPathFinderSource creator;
        readonly List<MovementSourceData3D> movementSourceData;
        readonly SingleLevelPathFinder singleLevelPathFinder;
        bool disposed;

        public PathFinder([NotNull] IPathFinderSource creator,
            ...
            )
        {
            ...
            this.singleLevelPathFinder = new SingleLevelPathFinder(astarNodePool, movementModePool);
        }
