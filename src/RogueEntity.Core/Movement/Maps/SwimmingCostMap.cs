...
{
    public class SwimmingCostMap : IReadOnlyMapData<MovementCost>
    {
        readonly IReadOnlyMapData<MovementCostProperties> flagData;
        readonly float baseCost;

        public SwimmingCostMap(IReadOnlyMapData<MovementCostProperties> flagData,
                               float baseCost)
        {
