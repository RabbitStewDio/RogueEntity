...
namespace RogueEntity.Core.Sensing.Common
{
    ...
    /// </summary>
    public sealed class SenseSourceData : IReadOnlyView2D<float>, IReadOnlyView2D<SenseDirectionStore>, ISenseDataView
    {
        ...
        public bool TryGet(int x, int y, out SenseDirectionStore data)
        {
            ...
            var linIndex = dx + dy * LineWidth;
            data = new SenseDirectionStore(Directions[linIndex]);
            return true;
        }
