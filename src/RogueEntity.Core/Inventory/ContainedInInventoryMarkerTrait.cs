...
namespace RogueEntity.Core.Inventory
{
    ...
    /// </summary>
    public class ContainedInInventoryMarkerTrait<TGameContext, TOwnerId, TItemId> :
        SimpleItemComponentTraitBase<TGameContext, TItemId, ContainedInInventoryMarker<TOwnerId, TItemId>>
        where TItemId : IBulkDataStorageKey<TItemId>
    {
        public ContainedInInventoryMarkerTrait() : base("Core.Item.ParentContainerMarker", 100)
        {
        }
