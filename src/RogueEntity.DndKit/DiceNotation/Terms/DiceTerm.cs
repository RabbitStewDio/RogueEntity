...
namespace RogueEntity.DndKit.DiceNotation.Terms
{
	...
	public class DiceTerm : ITerm
	{
		...
		/// each individual die.
		/// </summary>
		public List<int> DiceResults { get => _diceResults; }

		/// <summary>
		/// The result of evaluating the <see cref="Multiplicity"/> term that was used during the last call to <see cref="GetResult(Func{double})"/>.
		/// </summary>
		public int LastMultiplicity { get; private set; }

		/// <summary>
		/// The result of evaluating the <see cref="Sides"/> term that was used during the last call to <see cref="GetResult(Func{double})"/>.
		/// </summary>
