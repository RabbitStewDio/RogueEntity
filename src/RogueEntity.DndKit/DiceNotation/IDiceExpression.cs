...
namespace RogueEntity.DndKit.DiceNotation
{
	...
	public interface IDiceExpression
	{
        ...
        /// </summary>
        /// <remarks>
        /// Typically this can be implemented by calling <see cref="Roll(Func{double})"/> and passing in a <see cref="GeneratorExtensions.MaxRandom"/> instance.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Typically this can be implemented by calling <see cref="Roll(Func{double})"/> and passing in a <see cref="GeneratorExtensions.MinRandom"/> instance.
        /// </remarks>
